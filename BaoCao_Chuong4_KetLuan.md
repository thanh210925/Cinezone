...
- Tích hợp thêm các ví điện tử phổ biến tại Việt Nam như **MoMo, ZaloPay, Viettel Money, Apple Pay và Google Pay**.ây dựng phân hệ **Thẻ thành viên & Tích điểm đổi quà (Loyalty Points & Tier System)**: Phân hạng thành viên (Bạc, Vàng, Kim Cương), cho phép đổi điểm lấy vé miễn phí hoặc combo bắp nước.
