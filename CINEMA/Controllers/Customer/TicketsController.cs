...
namespace CINEMA.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public IActionResult MyTickets()
        {
            ...
            return Redirect("/Customer/Profile#ordersTab");
        }
        ...
        public async Task<IActionResult> Pay(int orderId, string? method = null)
        {
            ...
            if (order.PaymentMethod == "Online" || order.PaymentMethod == "Stripe")
            {
                return RedirectToAction("PayWithStripe", "Payment", new { orderId = order.OrderId });
            }

            return RedirectToAction("VietQRPayment", "Payment", new { orderId = order.OrderId });
        }
