...
namespace CINEMA.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> ProcessCheck([FromBody] AttendanceDto model)
        {
            ...
            // Retrieve today's work schedules for the admin
            var schedules = await _context.WorkSchedules
                .Include(ws => ws.Shift)
            ...
            // Prepare folder for saving attendance photos
            ...
            // Duplicate save and return removed
        }
        ...
        public async Task<IActionResult> GetActiveChats()
        {
            ...
            var activeChats = await _context.ChatMessages
                ...
                .Select(g => new
                {
                    ...
                    AvatarUrl = g.FirstOrDefault().Customer.Avatar ?? g.FirstOrDefault().Customer.AvatarUrl ?? "/images/default-avatar.png",
                    LastMessage = g.OrderByDescending(m => m.CreatedAt).FirstOrDefault().MessageText,
        ...
        public async Task<IActionResult> GetChatHistoryAdmin(int customerId)
        {
            ...
            var messages = await _context.ChatMessages
                ...
                .Select(m => new
                {
                    ...
                    senderName = m.IsFromCustomer ? m.Customer.FullName : "Nhân viên hỗ trợ",
                    text = m.MessageText,
