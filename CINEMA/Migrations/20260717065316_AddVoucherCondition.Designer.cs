...
namespace CINEMA.Migrations
{
    ...
    [Migration("20260717065316_AddVoucherCondition")]
    partial class AddVoucherCondition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CINEMA.Models.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("CINEMA.Models.FaceEmbedding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CINEMA.Models.GroupBookingMember", b =>
                {
                    ...
                    b.ToTable("GroupBookingMembers");
                });

            modelBuilder.Entity("CINEMA.Models.GroupBookingRoom", b =>
                {
                    b.Property<string>("RoomId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("CINEMA.Models.VoucherCondition", b =>
                {
                    ...
                    b.Property<int?>("MinGroupMembers")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("RequireCombo")
                        .HasColumnType("bit");

                    b.Property<bool>("RequireGroupBooking")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CINEMA.Models.GroupBookingMember", b =>
                {
                    ...
                    b.HasOne("CINEMA.Models.GroupBookingRoom", "Room")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("CINEMA.Models.GroupBookingRoom", b =>
                {
                    b.HasOne("CINEMA.Models.Customer", "Creator")
                        .WithMany()
